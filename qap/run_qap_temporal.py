...
def build_temporal_qap_workflow(resource_pool, config, subject_id, \
                                run_name, scan_id):
    ...
    if "qap_temporal" not in resource_pool.keys():
        ...
        from qclib.qap_workflows import qap_temporal_workflow
...
def main():
    ...
    if args.subj_idx and not args.creds_path and not args.sublist:
        ...
        if args.subj_idx and args.creds_path:
            ...
            sub_dict = dl_subj_from_s3(args.subj_idx, 'func', args.creds_path)
